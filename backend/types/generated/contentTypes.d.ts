...
export interface ApiPedidoPedido extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    estatus: Schema.Attribute.Enumeration<
      ['Recibida', 'Atendida', 'Entregado']
    > &
      Schema.Attribute.DefaultTo<'Recibida'>;
    fecha_compra: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pedido.pedido'
    > &
      Schema.Attribute.Private;
    nombre_contacto: Schema.Attribute.String;
    productos_comprados: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categoria: Schema.Attribute.Enumeration<
      ['Anillos', 'Collares', 'Pulseras', 'Relojes', 'Aretes']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descripcion: Schema.Attribute.Text;
    esOferta: Schema.Attribute.Boolean;
